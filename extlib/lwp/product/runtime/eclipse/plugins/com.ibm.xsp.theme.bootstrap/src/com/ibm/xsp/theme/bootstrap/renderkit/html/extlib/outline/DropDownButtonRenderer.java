...
public class DropDownButtonRenderer extends OutlineDropDownButtonRenderer {

    @Override
    protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
        return new com.ibm.xsp.theme.bootstrap.renderkit.html.extlib.outline.tree.DropDownButtonRenderer();
    }
}