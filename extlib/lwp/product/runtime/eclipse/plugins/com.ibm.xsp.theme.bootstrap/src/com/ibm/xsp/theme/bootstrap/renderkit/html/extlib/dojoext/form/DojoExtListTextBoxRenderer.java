...
* Date: 19 Sep 2014
* DojoExtListTextBoxRenderer.java
*/
 ...
 * @author Brian Gleeson (brian.gleeson@ie.ibm.com)
 */
public class DojoExtListTextBoxRenderer extends com.ibm.xsp.extlib.renderkit.dojoext.form.DojoExtListTextBoxRenderer {

    @Override
    protected String getDefaultDojoType(FacesContext context, FacesDojoComponent component) {
        return "extlib.responsive.dijit.xsp.bootstrap.ListTextBox"; // $NON-NLS-1$
    }
    
    @Override
    protected DojoModuleResource getDefaultDojoModule(FacesContext context, FacesDojoComponent component) {
        return Resources.bootstrapListTextBox;
    }
}
