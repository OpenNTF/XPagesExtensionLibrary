...
public class WidgetDropDownRenderer extends TreePopupMenuRenderer {
	...
	protected void renderPopupButton(FacesContext context, ResponseWriter writer, TreeContextImpl tree, boolean enabled, boolean selected) throws IOException {
		...
		writer.writeAttribute("href", "javascript:;", null); // $NON-NLS-1$
																// $NON-NLS-2$
		writer.writeAttribute("title", "click for actions", null); // $NON-NLS-1$
																	// $NLS-OneUIWidgetDropDownRenderer.clickforactions-2$
		writer.writeAttribute("aria-haspopup", "true", null); // $NON-NLS-1$
																// $NON-NLS-2$
		writer.startElement("img", null); // $NON-NLS-1$
		writer.writeAttribute("src", HtmlRendererUtil.getImageURL(context, "/.ibmxspres/.extlib/responsive/xpages/img/widget_dropdown.png"), null); // $NON-NLS-1$
		writer.writeAttribute("alt", "", null); // $NON-NLS-1$
		writer.writeAttribute("aria-label", "action button", null); // $NON-NLS-1$
																	// $NON-NLS-2$
		writer.endElement("img"); // $NON-NLS-1$
		writer.startElement("span", null); // $NON-NLS-1$
		writer.writeAttribute("class", "lotusAltText", null); // $NON-NLS-1$
																// $NON-NLS-2$
