 ...
 * @author Brian Gleeson (brian.gleeson@ie.ibm.com)
 */
public class ReadOnlyCheckboxRenderer extends CheckboxRenderer {

	static final String DISABLED = "disabled"; //$NON-NLS-1$
	static final String READONLY = "readonly"; //$NON-NLS-1$
	
    /* (non-Javadoc)
     * @see com.ibm.xsp.renderkit.html_extended.CheckboxRenderer#decode(javax.faces.context.FacesContext, javax.faces.component.UIComponent)
     */
    @Override
