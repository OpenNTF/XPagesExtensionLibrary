...
import com.ibm.xsp.extlib.renderkit.html_extended.outline.tree.DropDownButtonRenderer;
import com.ibm.xsp.extlib.tree.ITreeRenderer;



public class OutlineDropDownButtonRenderer extends AbstractOutlineRenderer {

	@Override
	protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
		return new DropDownButtonRenderer();
	}
