...
import com.ibm.xsp.extlib.component.dojoext.form.AbstractDojoExtListTextBox;
...
public abstract class DojoAbstractExtListTextBoxRenderer extends DojoFormWidgetRenderer {
    ...
    protected void initDojoAttributes(FacesContext context, FacesDojoComponent dojoComponent, Map<String,String> attrs) throws IOException {
        ...
        if(dojoComponent instanceof AbstractDojoExtListTextBox) {
            AbstractDojoExtListTextBox c = (AbstractDojoExtListTextBox)dojoComponent;
