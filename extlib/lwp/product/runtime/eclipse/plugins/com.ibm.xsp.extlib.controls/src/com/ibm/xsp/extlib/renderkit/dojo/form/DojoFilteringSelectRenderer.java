...
public class DojoFilteringSelectRenderer extends DojoComboBoxRenderer {
    ...
    protected void initDojoAttributes(FacesContext context, FacesDojoComponent dojoComponent, Map<String,String> attrs) throws IOException {
        ...
        if(dojoComponent instanceof UIDojoFilteringSelect) {
            UIDojoFilteringSelect c = (UIDojoFilteringSelect)dojoComponent;
            DojoRendererUtil.addDojoHtmlAttributes(attrs,"labelAttr",c.getLabelAttr()); // $NON-NLS-1$
            DojoRendererUtil.addDojoHtmlAttributes(attrs,"labelType",c.getLabelType()); // $NON-NLS-1$
            DojoRendererUtil.addDojoHtmlAttributes(attrs,"labelFunc",c.getLabelFunc()); // $NON-NLS-1$
        }
    }
}