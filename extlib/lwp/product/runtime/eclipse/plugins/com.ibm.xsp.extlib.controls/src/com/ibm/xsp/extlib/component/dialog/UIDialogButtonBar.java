 ...
 * </p>
 */
public class UIDialogButtonBar extends UIPanel implements ThemeControl {
	
    public static final String COMPONENT_TYPE = "com.ibm.xsp.extlib.dialog.DialogButtonBar"; //$NON-NLS-1$
	public static final String COMPONENT_FAMILY = "com.ibm.xsp.extlib.Dialog"; //$NON-NLS-1$
	public static final String RENDERER_TYPE = "com.ibm.xsp.extlib.dialog.DialogButtonBar"; //$NON-NLS-1$
	
	private String style;
	private String styleClass;
	
	public UIDialogButtonBar() {
	...
	public String getStyleKitFamily() {
		return StyleKitExtLibDefault.DIALOGBAR;
	}
