...
import com.ibm.xsp.extlib.component.dojo.converter.TimeConverter;
import com.ibm.xsp.extlib.component.dojo.form.constraints.DateTimeConstraints;
import com.ibm.xsp.util.FacesUtil;

/**
 * Dojo TimeTextBox component. 
 * 
 * @author Philippe Riand
 */
public class UIDojoTimeTextBox extends UIDojoRangeBoundTextBox {

    public static final String COMPONENT_TYPE = "com.ibm.xsp.extlib.dojo.form.TimeTextBox"; //$NON-NLS-1$
    public static final String RENDERER_TYPE = "com.ibm.xsp.extlib.dojo.form.TimeTextBox"; //$NON-NLS-1$

    private DateTimeConstraints constraints;
	
	public UIDojoTimeTextBox() {
