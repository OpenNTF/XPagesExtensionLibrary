...
import com.ibm.xsp.extlib.renderkit.html_extended.outline.tree.DojoAccordionRenderer;
import com.ibm.xsp.extlib.tree.ITreeRenderer;


public class DojoOutlineAccordionRenderer extends AbstractOutlineRenderer {
	
	@Override
	protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
		DojoAccordionRenderer r = new DojoAccordionRenderer(outline.getClientId(context));
		return r;
	}
