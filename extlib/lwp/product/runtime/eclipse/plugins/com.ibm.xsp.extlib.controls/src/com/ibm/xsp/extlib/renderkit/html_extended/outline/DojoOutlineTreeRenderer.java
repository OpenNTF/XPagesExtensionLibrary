...
import com.ibm.xsp.extlib.renderkit.html_extended.outline.tree.DojoTreeRenderer;
import com.ibm.xsp.extlib.tree.ITreeRenderer;


public class DojoOutlineTreeRenderer extends AbstractOutlineRenderer {

	@Override
	protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
		return new DojoTreeRenderer(outline.getClientId(context));
	}
}