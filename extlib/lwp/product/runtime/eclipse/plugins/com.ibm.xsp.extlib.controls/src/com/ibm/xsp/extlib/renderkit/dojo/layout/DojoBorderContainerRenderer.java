...
public class DojoBorderContainerRenderer extends DojoLayoutRenderer {
    ...
    protected void initDojoAttributes(FacesContext context, FacesDojoComponent dojoComponent, Map<String,String> attrs) throws IOException {
        ...
        if(dojoComponent instanceof UIDojoBorderContainer) {
            UIDojoBorderContainer c = (UIDojoBorderContainer)dojoComponent;

            DojoRendererUtil.addDojoHtmlAttributes(attrs,"design",c.getDesign()); // $NON-NLS-1$
            DojoRendererUtil.addDojoHtmlAttributes(attrs,"gutters",c.isGutters(), true); // $NON-NLS-1$
            DojoRendererUtil.addDojoHtmlAttributes(attrs,"liveSplitters",c.isLiveSplitters(), true); // $NON-NLS-1$
