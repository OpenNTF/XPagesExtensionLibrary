...
public class DojoDateTextBoxRenderer extends DojoRangeBoundTextBoxRenderer {
    ...
    protected void initDojoAttributes(FacesContext context, FacesDojoComponent dojoComponent, Map<String,String> attrs) throws IOException {
        ...
        if(dojoComponent instanceof UIDojoDateTextBox) {
            UIDojoDateTextBox c = (UIDojoDateTextBox)dojoComponent;
            DateTimeConstraints nc = c.getConstraints();
            if(nc!=null) {
                DojoRendererUtil.addDojoHtmlAttributes(attrs,"constraints",nc.createDateConstraintsAsJson()); // $NON-NLS-1$
            }
        }
    }
}