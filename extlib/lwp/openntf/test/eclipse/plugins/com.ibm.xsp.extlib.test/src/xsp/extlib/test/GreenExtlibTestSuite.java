 ...
 * @author Maire Kehoe (mkehoe@ie.ibm.com)
 */
public class GreenExtlibTestSuite extends TestSuite {

    public static Test suite() { 
        ExtlibTestSuite mainSuite = new ExtlibTestSuite();
        List<Class<?>> testClasses = ExtlibTestSuite.getTestClassList();
        ...
        GreenExtlibTestSuite greenSuite = new GreenExtlibTestSuite();
