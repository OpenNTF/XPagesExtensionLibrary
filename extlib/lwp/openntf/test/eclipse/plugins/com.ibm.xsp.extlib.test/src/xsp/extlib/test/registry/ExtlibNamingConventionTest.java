...
public class ExtlibNamingConventionTest extends BaseNamingConventionTest {
    ...
    private String[] skips_warning = new String[]{
            ...
            "com/ibm/xsp/extlib/config/extlib-dynamiccontent.xsp-config/xe:inPlaceFormAction [Rule13b] Bad complex-class package name com.ibm.xsp.extlib.actions.server.InPlaceFormAction has extra subpackage, expected [actions] but was [actions.server]",
