...
* Date: 17 Feb 2012
* ExtlibRenderThemeControlTest.java
*/
 ...
 * @author Maire Kehoe (mkehoe@ie.ibm.com)
 */
public class ExtlibRenderThemeControlTest extends BaseRenderThemeControlTest {
    @Override
    ...
    protected void validateContributedThemes(List<String> contributedThemes,
    	...
    	if( ConfigUtil.isRequireBootstrapTheme(this) /*defaults to not-required*/ ){
    		if( ! contributedThemes.contains("TwitterBootstrap") ){
    			throw new RuntimeException("The TwitterBoostrap.theme file contribution was not found. "
    					+ "Please verify that the test project "
    					+ "depends on the plugin com.ibm.xsp.theme.twitter.bootstrap");
    		}
    		/* android.theme, iphone.theme, blackberry.theme
    		 * [blackberry theme was never supported]*/
    		minimumExpected += (3);
