...
* Date: 23 May 2011
* BasePropertyCategoryKnownTest.java
*/
 ...
 * @author Maire Kehoe (mkehoe@ie.ibm.com)
 */
public class BasePropertyCategoryKnownTest extends PropertyCategoryKnownTest {

    private String[] _expectedCategories = new String[]{
            "basics",
            "data",
            "dojo",
            "events",
