...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjTextAreaVisualizer;

public class DjTextAreaVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjTextAreaVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dojoform/DojoTextArea.png\">");
