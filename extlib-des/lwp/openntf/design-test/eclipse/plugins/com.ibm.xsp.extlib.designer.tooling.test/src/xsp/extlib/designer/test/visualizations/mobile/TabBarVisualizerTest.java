...
import com.ibm.xsp.extlib.designer.tooling.visualizations.mobile.TabBarVisualizer;

public class TabBarVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new TabBarVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:5px\" value=\"Tab Bar\"></xp:label>");
