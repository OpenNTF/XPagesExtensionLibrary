...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjValidationTextBoxVisualizer;

public class DjValidationTextBoxVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjValidationTextBoxVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:convertMask>");
		strBuilder.append("</xp:convertMask>");
		strBuilder.append("</xp:this.converter>");
