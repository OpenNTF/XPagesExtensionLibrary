...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.ToolbarVisualizer;

public class ToolbarVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new ToolbarVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/CutIcon.png\">");
		strBuilder.append("</xp:image>");
		strBuilder.append("<xp:label style=\"padding:2px\" value=\"Cut\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/CopyIcon.png\">");
		strBuilder.append("</xp:image>");
		strBuilder.append("<xp:label style=\"padding:2px\" value=\"Copy\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/PasteIcon.png\">");
		strBuilder.append("</xp:image>");
		strBuilder.append("<xp:label style=\"padding:2px\" value=\"Paste\">");
		strBuilder.append("</xp:label>");
