...
import com.ibm.xsp.extlib.designer.tooling.visualizations.mobile.TabBarButtonVisualizer;

public class TabBarButtonVisualizerTest extends AbstractDynamicVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new TabBarButtonVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("labelValue=\"Tab Bar Button\";");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("}");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("%>");
		strBuilder.append("<xp:button style=\"margin:1px\"><xp:this.value><%=labelValue%></xp:this.value>");
	...
	public String getExpectedProcessedFullXSPMarkup() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:button style=\"margin:1px\"><xp:this.value>Tab Bar Button</xp:this.value>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:button>");
		strBuilder.append(LINE_DELIMITER);
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingAttributes() {
		...
		strBuilder.append("<xp:view xmlns:xp=\"http://www.ibm.com/xsp/core\">");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:button style=\"margin:1px\"><xp:this.value>Button</xp:this.value>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:button>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:view>");
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingComputedAttributes() {
		...
		strBuilder.append("<xp:view xmlns:xp=\"http://www.ibm.com/xsp/core\">");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:button style=\"margin:1px\"><xp:this.value>"+TEST_JAVASCRIPT+"</xp:this.value>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:button>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:view>");
