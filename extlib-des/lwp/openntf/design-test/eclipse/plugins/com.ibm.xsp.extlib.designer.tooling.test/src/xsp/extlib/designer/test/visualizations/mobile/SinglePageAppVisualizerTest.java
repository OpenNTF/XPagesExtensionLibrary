...
import com.ibm.xsp.extlib.designer.tooling.visualizations.mobile.SinglePageAppVisualizer;

public class SinglePageAppVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new SinglePageAppVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Single Page Application\"></xp:label>");
