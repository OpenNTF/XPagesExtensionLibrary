...
import com.ibm.xsp.extlib.designer.tooling.visualizations.inotes.ListViewVisualizer;

public class ListViewVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new ListViewVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"iNotes List View\"></xp:label>");
