...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjImageSelectVisualizer;

public class DjImageSelectVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjImageSelectVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dojoform/DojoImageSelectImage.png\">");
