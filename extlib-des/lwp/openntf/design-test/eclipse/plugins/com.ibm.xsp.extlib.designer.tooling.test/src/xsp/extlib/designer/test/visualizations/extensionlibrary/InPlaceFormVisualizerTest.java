...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.InPlaceFormVisualizer;

public class InPlaceFormVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new InPlaceFormVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/InPlaceFormIcon.png\">");
