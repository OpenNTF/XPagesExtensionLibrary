...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.OutlineVisualizer;

public class OutlineVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new OutlineVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:table style=\"color:rgb(16,92,182);border-style:solid;border-width:1px;border-color:rgb(192,192,192)\">");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none;padding-right:5px\">");
		strBuilder.append("Outline item 1");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none;padding-right:5px\">");
		strBuilder.append("Outline item 2");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none;padding-right:5px\">");
		strBuilder.append("Outline item 3");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
