...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.PagerDetailVisualizer;

public class PagerDetailVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new PagerDetailVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"padding:5px\" value=\"Hide Details\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding-top:5px;padding-bottom:5px\" value=\"|\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding:5px;color:rgb(66,92,182)\" value=\"Show Details\">");
		strBuilder.append("</xp:label>");
