...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjRadioButtonVisualizer;

public class DjRadioButtonVisualizerTest extends AbstractDynamicVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjRadioButtonVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:radio id=\"radio1\">");
		strBuilder.append("<xp:this.text><%=labelValue%></xp:this.text>");
		strBuilder.append("</xp:radio>");
	...
	public String getExpectedProcessedFullXSPMarkup() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:radio id=\"radio1\"><xp:this.text></xp:this.text>");
		strBuilder.append("</xp:radio>");
		strBuilder.append(LINE_DELIMITER);
	...
	public HashMap<String, String> getAttributesToSet() {
		...
		attributes.put("label","Radio Button");
		return attributes;
	}
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingAttributes() {
		...
		strBuilder.append("<xp:view xmlns:xp=\"http://www.ibm.com/xsp/core\">");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:radio id=\"radio1\"><xp:this.text>Radio Button</xp:this.text>");
		strBuilder.append("</xp:radio>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:view>");
		return strBuilder.toString();
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingComputedAttributes() {
		...
		strBuilder.append("<xp:view xmlns:xp=\"http://www.ibm.com/xsp/core\">");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:radio id=\"radio1\"><xp:this.text>"+TEST_JAVASCRIPT+"</xp:this.text>");
		strBuilder.append("</xp:radio>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:view>");
		return strBuilder.toString();
