...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjSliderRuleLabelsVisualizer;

public class DjSliderRuleLabelsVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjSliderRuleLabelsVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dojoform/sliderLabels.png\">");
