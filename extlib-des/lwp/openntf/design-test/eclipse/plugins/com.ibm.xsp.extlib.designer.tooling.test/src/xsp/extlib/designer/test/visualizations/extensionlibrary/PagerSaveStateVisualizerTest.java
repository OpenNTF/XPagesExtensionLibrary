...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.PagerSaveStateVisualizer;

public class PagerSaveStateVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new PagerSaveStateVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/PagerSaveState.png\">");
