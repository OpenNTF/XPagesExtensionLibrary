...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dataaccess.RestServiceVisualizer;

public class RestServiceVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new RestServiceVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dataaccess/RestService.png\">");
