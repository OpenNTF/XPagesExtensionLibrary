...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.BreadCrumbsVisualizer;

public class BreadCrumbsVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new BreadCrumbsVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:span style=\"color:rgb(16,92,182)\">");
		...
		strBuilder.append("</xp:span>");
		strBuilder.append("<xp:span style=\"color:rgb(0,0,0)\">");
		strBuilder.append("&gt; Subpage");
		strBuilder.append("</xp:span>");
