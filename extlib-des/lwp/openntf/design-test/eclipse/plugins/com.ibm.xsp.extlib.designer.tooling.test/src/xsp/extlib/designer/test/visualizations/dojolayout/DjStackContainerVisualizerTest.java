...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojolayout.DjStackContainerVisualizer;

public class DjStackContainerVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjStackContainerVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Stack Container\"></xp:label>");
