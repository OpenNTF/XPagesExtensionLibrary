...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.SwitchFacetVisualizer;

public class SwitchFacetVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new SwitchFacetVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:panel style=\"padding:5px;width:98%;border-color:rgb(192,192,192);border-style:solid;border-width:thin\">");
		strBuilder.append("<xp:callback><xp:this.facetName>#{Switch Facet}</xp:this.facetName>");
