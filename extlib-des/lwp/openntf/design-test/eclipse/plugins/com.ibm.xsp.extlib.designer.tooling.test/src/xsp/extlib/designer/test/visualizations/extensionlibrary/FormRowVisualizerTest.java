...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.FormRowVisualizer;

public class FormRowVisualizerTest extends AbstractDynamicVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new FormRowVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:callback facetName=\"help\"></xp:callback>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
		strBuilder.append("<xp:callback facetName=\"label\"></xp:callback>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
		strBuilder.append("<xp:label><xp:this.value><%=labelVar%></xp:this.value></xp:label>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
	...
	public String getExpectedProcessedFullXSPMarkup() {
		...
		strBuilder.append("<xp:callback facetName=\"label\"></xp:callback>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
		strBuilder.append("<xp:label><xp:this.value>Label</xp:this.value></xp:label>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingAttributes() {
		...
		strBuilder.append("<xp:callback facetName=\"label\"></xp:callback>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
		strBuilder.append("<xp:label><xp:this.value>Test Label</xp:this.value></xp:label>");
		strBuilder.append("<xp:label value=\" \"></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
