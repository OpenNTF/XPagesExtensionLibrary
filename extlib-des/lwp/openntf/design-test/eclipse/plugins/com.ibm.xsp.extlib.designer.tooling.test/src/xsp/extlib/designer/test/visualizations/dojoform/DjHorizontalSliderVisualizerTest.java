...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjHorizontalSliderVisualizer;

public class DjHorizontalSliderVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjHorizontalSliderVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dojoform/horizSlider.png\">");
