...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.PopupMenuVisualizer;

public class PopupMenuVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new PopupMenuVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:table style=\"border-color:rgb(126,171,205);border-style:solid;border-width:1px;background-color:rgb(247,247,247)\">");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none;padding-right:5px\">");
		strBuilder.append("Menu item 1");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("<xp:tr style=\"background-color:rgb(64,86,116);color:rgb(255,255,255)\">");
		strBuilder.append("<xp:td style=\"border:none;padding-right:5px\">");
		strBuilder.append("Menu item 2");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none;padding-right:5px\">");
		strBuilder.append("Menu item 3");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
