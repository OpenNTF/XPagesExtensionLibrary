...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjTimeTextBoxVisualizer;

public class DjTimeTextBoxVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjTimeTextBoxVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:convertDateTime type=\"time\">");
		strBuilder.append("</xp:convertDateTime>");
		strBuilder.append("</xp:this.converter>");
