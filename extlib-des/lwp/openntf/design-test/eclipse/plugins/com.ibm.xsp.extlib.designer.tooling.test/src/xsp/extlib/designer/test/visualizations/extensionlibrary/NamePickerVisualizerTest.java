...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.NamePickerVisualizer;

public class NamePickerVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new NamePickerVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image style=\"border-color:rgb(170,170,170);border-style:solid;border-width:thin\" url=\"/extlib/designer/markup/extensionlibrary/NamePicker.png\">");
