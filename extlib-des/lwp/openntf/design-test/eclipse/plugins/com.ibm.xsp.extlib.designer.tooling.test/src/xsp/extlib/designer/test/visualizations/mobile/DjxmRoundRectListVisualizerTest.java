...
import com.ibm.xsp.extlib.designer.tooling.visualizations.mobile.DjxmRoundRectListVisualizer;

import xsp.extlib.designer.test.visualizations.AbstractVisualizationTest;

public class DjxmRoundRectListVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjxmRoundRectListVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:table style=\"width:98%;border-color:rgb(192,192,192);border-style:solid;border-width:thin;margin:1px\">");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Rounded Rectangle\"></xp:label>");
