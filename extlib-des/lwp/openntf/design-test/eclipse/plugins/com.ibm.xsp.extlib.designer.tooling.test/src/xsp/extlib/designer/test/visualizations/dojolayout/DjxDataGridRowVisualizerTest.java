...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojolayout.DjxDataGridRowVisualizer;

public class DjxDataGridRowVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjxDataGridRowVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Dojo Data Grid Row\"></xp:label>");
