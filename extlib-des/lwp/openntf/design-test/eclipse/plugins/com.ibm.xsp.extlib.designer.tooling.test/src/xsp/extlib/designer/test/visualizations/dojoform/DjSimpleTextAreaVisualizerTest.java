...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjSimpleTextAreaVisualizer;

public class DjSimpleTextAreaVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjSimpleTextAreaVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dojoform/DojoSimpleTextArea.png\">");
