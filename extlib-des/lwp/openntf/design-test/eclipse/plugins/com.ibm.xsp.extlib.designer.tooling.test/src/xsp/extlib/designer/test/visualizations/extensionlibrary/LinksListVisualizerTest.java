...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.LinksListVisualizer;

public class LinksListVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new LinksListVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:span style=\"color:black\">");
		strBuilder.append(" | ");
		strBuilder.append("</xp:span>");
		strBuilder.append("<xp:span style=\"color:rgb(16,92,182)\">");
		strBuilder.append("Link");
