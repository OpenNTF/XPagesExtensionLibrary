...
import com.ibm.xsp.extlib.designer.tooling.visualizations.inotes.CalendarViewVisualizer;

public class CalendarViewVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new CalendarViewVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image style=\"border-color:rgb(170,170,170);border-style:solid;border-width:thin;margin:1px\" url=\"/extlib/designer/markup/inotes/CalendarIcon.png\">");
