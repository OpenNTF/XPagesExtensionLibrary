...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.DataViewVisualizer;

public class DataViewVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DataViewVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
        ...
        strBuilder.append("<td colspan=\"4\" valign=\"top\">"); 
        ...
        strBuilder.append("<tr>"); 
        strBuilder.append("<td colspan=\"4\" valign=\"top\">"); 
        strBuilder.append("<xp:label style=\"font-weight:bold;font-size:12pt;font-family:sans-serif\" value=\"Category\">");
        strBuilder.append("</xp:label>");
        strBuilder.append("<xp:br />"); 
        strBuilder.append("<xp:callback facetName=\"categoryRow\" />"); 
        strBuilder.append("</td>"); 
        strBuilder.append("</tr>"); 
        strBuilder.append("<tr>"); 
        strBuilder.append("<td valign=\"top\" width=\"150\" rowspan='2'>"); 
        strBuilder.append("<xp:callback facetName=\"icon\" />"); 
        strBuilder.append("</td>"); 
        ...
        strBuilder.append("</td>"); 
        strBuilder.append("<td valign=\"top\" rowspan='2'>"); 
        strBuilder.append("<xp:label style=\"font-style:italic\" value=\"Extra Columns...\">");
        strBuilder.append("</xp:label>");
        strBuilder.append("<xp:br />"); 
        strBuilder.append("</td>"); 
