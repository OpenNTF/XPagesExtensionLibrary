...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjCheckBoxVisualizer;

public class DjCheckBoxVisualizerTest extends AbstractDynamicVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjCheckBoxVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:checkBox id=\"checkBox1\">");
		strBuilder.append("<xp:this.text><%=labelValue%></xp:this.text>");
		strBuilder.append("</xp:checkBox>");
	...
	public String getExpectedProcessedFullXSPMarkup() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:checkBox id=\"checkBox1\">");
		strBuilder.append("<xp:this.text></xp:this.text>");
		strBuilder.append("</xp:checkBox>");
		strBuilder.append(LINE_DELIMITER);
	...
	public HashMap<String, String> getAttributesToSet() {
		...
		attributes.put("label","Check Box");
		return attributes;
	}
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingAttributes() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:checkBox id=\"checkBox1\">");
		strBuilder.append("<xp:this.text>Check Box</xp:this.text>");
		strBuilder.append("</xp:checkBox>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:view>");
		return strBuilder.toString();
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingComputedAttributes() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("<xp:checkBox id=\"checkBox1\">");
		strBuilder.append("<xp:this.text>"+TEST_JAVASCRIPT+"</xp:this.text>");
		strBuilder.append("</xp:checkBox>");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("</xp:view>");
		return strBuilder.toString();
