...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.SortLinksVisualizer;

public class SortLinksVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new SortLinksVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"padding:5px\" value=\"Sort by:\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding-top:5px;padding-bottom:5px;color:rgb(16,92,182)\" value=\"Key 1\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding-top:5px;padding-bottom:5px;color:rgb(204,204,204)\" value=\" | \">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding-top:5px;padding-bottom:5px;color:rgb(16,92,182)\" value=\"Key 2\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("</xp:span>");
