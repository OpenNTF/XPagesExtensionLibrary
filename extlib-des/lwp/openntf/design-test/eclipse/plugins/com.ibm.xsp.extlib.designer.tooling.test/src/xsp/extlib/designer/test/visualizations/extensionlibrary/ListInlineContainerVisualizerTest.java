...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.ListInlineVisualizer;

public class ListInlineContainerVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new ListInlineVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/ListInlineIcon.png\">");
