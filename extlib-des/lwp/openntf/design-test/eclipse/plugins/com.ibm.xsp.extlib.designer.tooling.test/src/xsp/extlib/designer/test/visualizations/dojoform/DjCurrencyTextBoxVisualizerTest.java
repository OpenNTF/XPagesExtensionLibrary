...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjCurrencyTextBoxVisualizer;

public class DjCurrencyTextBoxVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjCurrencyTextBoxVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:inputText id=\"inputText1\">");
		strBuilder.append("<xp:this.converter>");
		strBuilder.append("<xp:convertNumber type=\"number\">");
		strBuilder.append("</xp:convertNumber>");
		strBuilder.append("</xp:this.converter>");
		strBuilder.append("</xp:inputText>");
