 ...
 */
package xsp.extlib.designer.test.visualizations.dataaccess;

import xsp.extlib.designer.test.visualizations.AbstractVisualizationTest;

import com.ibm.xsp.extlib.designer.tooling.visualizations.dataaccess.JsonRpcServiceVisualizer;

public class JsonRpcServiceVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new JsonRpcServiceVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dataaccess/RPC.png\">");
