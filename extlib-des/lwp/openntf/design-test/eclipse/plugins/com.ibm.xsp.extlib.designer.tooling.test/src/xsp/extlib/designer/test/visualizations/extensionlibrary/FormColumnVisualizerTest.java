...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.FormColumnVisualizer;

public class FormColumnVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new FormColumnVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Form Layout Column\"></xp:label>");
