...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjSpinnerTextBoxVisualizer;

public class DjSpinnerTextBoxVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjSpinnerTextBoxVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:inputTextarea style=\"height:20px\">");
		strBuilder.append("</xp:inputTextarea>");
