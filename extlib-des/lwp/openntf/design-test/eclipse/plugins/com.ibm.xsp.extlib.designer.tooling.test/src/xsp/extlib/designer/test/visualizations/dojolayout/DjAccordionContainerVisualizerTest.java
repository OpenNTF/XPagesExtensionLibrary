...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojolayout.DjAccordionContainerVisualizer;

public class DjAccordionContainerVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjAccordionContainerVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Accordion Container\"></xp:label>");
