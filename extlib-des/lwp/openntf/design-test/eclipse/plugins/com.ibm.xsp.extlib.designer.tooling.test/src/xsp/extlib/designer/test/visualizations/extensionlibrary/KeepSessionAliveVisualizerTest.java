...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.KeepSessionAliveVisualizer;

public class KeepSessionAliveVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new KeepSessionAliveVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image style=\"border-color:rgb(170,170,170);border-style:solid;border-width:thin\" url=\"/extlib/designer/markup/extensionlibrary/ClockIcon.png\">");
