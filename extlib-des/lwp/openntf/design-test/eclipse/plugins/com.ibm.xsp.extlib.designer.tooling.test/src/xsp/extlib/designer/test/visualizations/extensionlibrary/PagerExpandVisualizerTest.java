...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.PagerExpandVisualizer;

public class PagerExpandVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new PagerExpandVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"padding:5px\" value=\"Collapse All\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding-top:5px;padding-bottom:5px\" value=\"|\">");
		strBuilder.append("</xp:label>");
		strBuilder.append("<xp:label style=\"padding:5px;color:rgb(66,92,182)\" value=\"Expand All\">");
		strBuilder.append("</xp:label>");
