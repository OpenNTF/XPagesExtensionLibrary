...
import com.ibm.xsp.extlib.designer.tooling.visualizations.mobile.DjxmLineItemVisualizer;

public class DjxmLineItemVisualizerTest extends AbstractDynamicVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjxmLineItemVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("var labelVar=this.title;");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("if(null==labelVar || labelVar==\"\"){");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("labelVar=\"Label\";");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("}");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("%>");
		strBuilder.append("<xp:table style=\"border-color:rgb(192,192,192);border-style:solid;border-width:thin;width:98%;margin:1px\">");
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:2px\"><xp:this.value><%=labelVar%></xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("<xp:td style=\"width:5%;border:none\">");
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/mobile/StaticLineItemIcon.png\"></xp:image>");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
	...
	public String getExpectedProcessedFullXSPMarkup() {
		...
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:2px\"><xp:this.value>Label</xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("<xp:td style=\"width:5%;border:none\">");
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/mobile/StaticLineItemIcon.png\"></xp:image>");
	...
	public HashMap<String, String> getAttributesToSet() {
		...
		attributes.put("title","Line Item Heading");
		return attributes;
	}
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingAttributes() {
		...
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:2px\"><xp:this.value>Line Item Heading</xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("<xp:td style=\"width:5%;border:none\">");
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/mobile/StaticLineItemIcon.png\"></xp:image>");
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingComputedAttributes() {
		...
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:2px\"><xp:this.value>"+TEST_JAVASCRIPT+"</xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("<xp:td style=\"width:5%;border:none\">");
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/mobile/StaticLineItemIcon.png\"></xp:image>");
