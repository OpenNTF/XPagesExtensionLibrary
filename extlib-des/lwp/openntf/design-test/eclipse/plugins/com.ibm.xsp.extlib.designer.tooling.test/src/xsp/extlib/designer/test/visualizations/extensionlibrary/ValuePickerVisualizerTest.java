...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.ValuePickerVisualizer;

public class ValuePickerVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new ValuePickerVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/ValuePicker.png\">");
