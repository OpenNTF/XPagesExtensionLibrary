...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.DialogButtonBarVisualizer;

public class DialogButtonBarVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DialogButtonBarVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:table style=\"width:98%;background-color:rgb(240,240,240);border-color:rgb(170,170,170);border-style:solid;border-width:thin\">");
		strBuilder.append("<xp:tr style=\"background-color:rgb(226,235,241)\">");
		strBuilder.append("<xp:td style=\"border:none;border-color:rgb(226,235,241);border-style:solid;border-width:medium\">");
