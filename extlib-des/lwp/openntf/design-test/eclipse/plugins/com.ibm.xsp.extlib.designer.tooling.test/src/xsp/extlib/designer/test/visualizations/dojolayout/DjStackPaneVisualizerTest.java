...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojolayout.DjStackPaneVisualizer;

public class DjStackPaneVisualizerTest extends AbstractDynamicVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjStackPaneVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("titleVar=\"Stack Pane\";");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("}");
		strBuilder.append(LINE_DELIMITER);
		strBuilder.append("%>");
		...
		strBuilder.append("<xp:label style=\"margin-right:5px\"><xp:this.value><%=titleVar%></xp:this.value></xp:label>");
	...
	public String getExpectedProcessedFullXSPMarkup() {
		...
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:5px\"><xp:this.value>Stack Pane</xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("</xp:table>");
	...
	public HashMap<String, String> getAttributesToSet() {
		...
		attributes.put("title","Test Stack Pane Title");
		return attributes;
	}
	...
	public String getExpectedProcessedFullXSPMarkupAfterSettingAttributes() {
		...
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:5px\"><xp:this.value>Test Stack Pane Title</xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("</xp:table>");
	...
	/*
	 * (non-Javadoc)
	 * @see xsp.extlib.designer.test.visualizations.AbstractDynamicVisualizationTest#getExpectedProcessedFullXSPMarkupAfterSettingComputedComputedAttributes()
	 */
	@Override
	public String getExpectedProcessedFullXSPMarkupAfterSettingComputedAttributes() {
		...
		strBuilder.append("<xp:tr>");
		strBuilder.append("<xp:td style=\"border:none\">");
		strBuilder.append("<xp:label style=\"margin-right:5px\"><xp:this.value>"+TEST_JAVASCRIPT+"</xp:this.value></xp:label>");
		strBuilder.append("<xp:callback></xp:callback>");
		strBuilder.append("</xp:td>");
		strBuilder.append("</xp:tr>");
		strBuilder.append("</xp:table>");
