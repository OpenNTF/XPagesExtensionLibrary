...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjDateTextBoxVisualizer;

public class DjDateTextBoxVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjDateTextBoxVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:convertDateTime type=\"date\">");
