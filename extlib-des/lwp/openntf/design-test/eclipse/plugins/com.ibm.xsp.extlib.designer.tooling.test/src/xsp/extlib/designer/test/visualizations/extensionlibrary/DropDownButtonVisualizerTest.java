...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.DropDownButtonVisualizer;

public class DropDownButtonVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DropDownButtonVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/DropdownButton.png\">");
