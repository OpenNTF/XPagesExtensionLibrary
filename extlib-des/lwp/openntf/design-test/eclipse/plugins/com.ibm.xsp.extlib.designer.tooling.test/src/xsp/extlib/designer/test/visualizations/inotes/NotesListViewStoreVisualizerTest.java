...
import com.ibm.xsp.extlib.designer.tooling.visualizations.inotes.NotesListViewStoreVisualizer;

public class NotesListViewStoreVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new NotesListViewStoreVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px;margin-left:2px;margin-top:2px;margin-bottom:2px\" value=\"Notes List View Store\">");
