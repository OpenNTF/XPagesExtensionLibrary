...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojolayout.DjContentPaneVisualizer;

public class DjContentPaneVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjContentPaneVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Dojo Content Pane\"></xp:label>");
