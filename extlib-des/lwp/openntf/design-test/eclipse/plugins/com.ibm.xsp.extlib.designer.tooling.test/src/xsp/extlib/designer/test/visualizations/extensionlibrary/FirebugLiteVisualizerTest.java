...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.FirebugLiteVisualizer;

public class FirebugLiteVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new FirebugLiteVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px\" value=\"Firebug Lite\">");
