...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.DumpObjectVisualizer;

public class DumpObjectVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DumpObjectVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px\" value=\"Dump Object\">");
