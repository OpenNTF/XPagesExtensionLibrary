...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojoform.DjSliderRuleVisualizer;

public class DjSliderRuleVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjSliderRuleVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/dojoform/sliderRule.png\">");
