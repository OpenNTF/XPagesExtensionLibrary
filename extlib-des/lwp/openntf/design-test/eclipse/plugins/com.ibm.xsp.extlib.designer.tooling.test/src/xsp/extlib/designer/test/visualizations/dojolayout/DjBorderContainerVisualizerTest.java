...
import com.ibm.xsp.extlib.designer.tooling.visualizations.dojolayout.DjBorderContainerVisualizer;

public class DjBorderContainerVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new DjBorderContainerVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:label style=\"margin-right:2px\" value=\"Border Container\"></xp:label>");
