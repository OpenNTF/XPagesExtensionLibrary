...
import com.ibm.xsp.extlib.designer.tooling.visualizations.extensionlibrary.ListVisualizer;

public class ListVisualizerTest extends AbstractVisualizationTest {
	...
	protected void setUp() throws Exception {
		super.setUp();
		_visualizationFactory = new ListVisualizer();
	}
	...
	public String getExpectedXSPMarkup() {
		...
		strBuilder.append("<xp:image url=\"/extlib/designer/markup/extensionlibrary/ListIcon.png\">");
