...
public class ResourceHandler {
    ...
    private static ResourceBundle _specialAudienceBundle;
    ...
    public static String getSpecialAudienceString(String key){
        if (_specialAudienceBundle == null) {
            _specialAudienceBundle = getResourceBundle("specialAudience");//$NON-NLS-1$
        }
        return getResourceBundleString(_specialAudienceBundle, key);
    }
