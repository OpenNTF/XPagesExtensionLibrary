 ...
 *              <xp:td style="border:none;border-color:rgb(255,255,255);border-style:solid;border-width:medium">
 ...
 *
 */
public class DialogContentVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        row.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "background-color:rgb(255,255,255)"); // $NON-NLS-1$
