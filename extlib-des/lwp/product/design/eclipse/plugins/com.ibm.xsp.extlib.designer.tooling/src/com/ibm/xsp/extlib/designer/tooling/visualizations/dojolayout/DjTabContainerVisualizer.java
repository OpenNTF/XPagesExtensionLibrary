 ...
 *                  <xp:label style="margin-right:2px" value="Tab Container"></xp:label>
 ...
 *
 */
public class DjTabContainerVisualizer extends AbstractCommonControlVisualizer{

     private static String TAB_CONTAINER_STRING = "Tab Container"; // $NLX-DjTabContainerVisualizer.TabContainer-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, TAB_CONTAINER_STRING);
