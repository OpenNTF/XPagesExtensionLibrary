 ...
 * 
 *  <xp:image url="/extlib/designer/markup/dojoform/DojoSimpleTextArea.png">
 *  </xp:image>
 * 
 *  </xp:view>
 *
 */
public class DjSimpleTextAreaVisualizer extends AbstractCommonControlVisualizer{

    private static final String SLIDER_IMAGE = "DojoSimpleTextArea.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(SLIDER_IMAGE, DOJO_FORM_IMAGES_LOCATION));
