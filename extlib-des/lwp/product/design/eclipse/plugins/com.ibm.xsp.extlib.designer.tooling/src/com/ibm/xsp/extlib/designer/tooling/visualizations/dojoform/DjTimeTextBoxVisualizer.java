 ...
 *
 */
public class DjTimeTextBoxVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag convertTimeTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_CONVERTER_CONVERT_DATE_TIME);
        convertTimeTag.addAttribute(XSPAttributeNames.XSP_ATTR_TYPE, XSPAttributeNames.XSP_ATTR_VAL_TIME);
        thisConverterTag.addChildTag(convertTimeTag);
