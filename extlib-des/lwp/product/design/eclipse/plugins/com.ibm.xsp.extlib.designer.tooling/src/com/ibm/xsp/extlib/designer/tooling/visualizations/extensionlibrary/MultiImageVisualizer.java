 ...
 * 
 *      <xp:image url="/extlib/designer/markup/extensionlibrary/MultiImageImage.png">
 *      </xp:image>
 *  
 *      <xp:image url="/extlib/designer/markup/extensionlibrary/MultiImageImage.png">
 *      </xp:image>
 ...
 *
 */
public class MultiImageVisualizer extends AbstractCommonControlVisualizer{

private static final String MULTI_IMAGE_IMAGE = "MultiImageImage.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(MULTI_IMAGE_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION));
