 ...
 *                  <xp:label style="margin-right:2px" value="Mobile Page"></xp:label>
 ...
 *
 */
public class AppPageVisualizer extends AbstractCommonControlVisualizer{

    private static String MOBILE_PAGE_STRING = "Application Page"; // $NLX-AppPageVisualizer.MobilePage-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, MOBILE_PAGE_STRING);
