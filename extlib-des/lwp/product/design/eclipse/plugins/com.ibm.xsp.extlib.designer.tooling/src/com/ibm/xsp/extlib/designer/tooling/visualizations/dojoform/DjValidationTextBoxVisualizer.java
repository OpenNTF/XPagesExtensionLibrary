 ...
 *
 */
public class DjValidationTextBoxVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag convertMaskTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_CONVERTER_CONVERT_MASK);
        thisConverterTag.addChildTag(convertMaskTag);
