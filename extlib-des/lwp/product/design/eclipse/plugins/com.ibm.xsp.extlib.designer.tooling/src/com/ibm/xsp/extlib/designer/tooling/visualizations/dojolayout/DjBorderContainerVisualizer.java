 ...
 *                  <xp:label style="margin-right:2px" value="Border Container"></xp:label>
 ...
 *
 */
public class DjBorderContainerVisualizer extends AbstractCommonControlVisualizer{

    private static String BORDER_CONTAINER_STRING = "Border Container"; // $NLX-DjBorderContainerVisualizer.BorderContainer-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, BORDER_CONTAINER_STRING);
