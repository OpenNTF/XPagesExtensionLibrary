 ...
 *                  <xp:label style="margin-right:2px" value="Single Page Application"></xp:label>
 ...
 *
 */
public class SinglePageAppVisualizer extends AbstractCommonControlVisualizer{

    private static String SINGLE_PAGE_APP_STRING = "Single Page Application"; // $NLX-SinglePageAppVisualizer.SinglePageApplication-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, SINGLE_PAGE_APP_STRING);
