 ...
 * 
 *  <xp:image url="/extlib/designer/markup/dojoform/DojoImageSelectImage.png">
 *  </xp:image>
 *
 *  <xp:image url="/extlib/designer/markup/dojoform/DojoImageSelectImage.png">
 *  </xp:image>
 ...
 *
 */
public class DjImageSelectVisualizer extends AbstractCommonControlVisualizer{

	private static final String IMAGE_SELECT_IMAGE = "DojoImageSelectImage.png"; // $NON-NLS-1$
	...
	public String getXSPMarkupForControl(Node nodeToVisualize,	IVisualizationCallback callback, FacesRegistry registry) {
		...
		strBuilder.append(createImageTag(IMAGE_SELECT_IMAGE, DOJO_FORM_IMAGES_LOCATION));
