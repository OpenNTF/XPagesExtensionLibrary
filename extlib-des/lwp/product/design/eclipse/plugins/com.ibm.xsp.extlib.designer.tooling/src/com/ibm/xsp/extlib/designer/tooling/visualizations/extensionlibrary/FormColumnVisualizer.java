 ...
 *                  <xp:label style="margin-right:2px" value="Form Layout Column"></xp:label>
 ...
 *
 */
public class FormColumnVisualizer extends AbstractCommonControlVisualizer{

     private static String FORM_COLUMN_STRING = "Form Layout Column"; // $NLX-FormColumnVisualizer.FormLayoutColumn-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, FORM_COLUMN_STRING);
