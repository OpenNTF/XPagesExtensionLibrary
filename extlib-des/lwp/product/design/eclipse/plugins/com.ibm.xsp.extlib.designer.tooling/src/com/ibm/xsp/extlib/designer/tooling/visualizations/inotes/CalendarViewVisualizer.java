 ...
 * 
 *  <xp:image style="border-color:rgb(170,170,170);border-style:solid;border-width:thin;margin:1px" url="/extlib/designer/markup/inotes/CalendarIcon.png"></xp:image>
 *  </xp:image>
 * 
 *  </xp:view>
 *
 */
public class CalendarViewVisualizer extends AbstractCommonControlVisualizer{

    private static final String CALENDAR_IMAGE = "CalendarIcon.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag imageTag = createImageTagObj(CALENDAR_IMAGE, INOTES_IMAGES_LOCATION);
        imageTag.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "border-color:rgb(170,170,170);border-style:solid;border-width:thin;margin:1px"); // $NON-NLS-1$
