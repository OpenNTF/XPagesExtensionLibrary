 ...
 */
package com.ibm.xsp.extlib.designer.tooling.visualizations.dataaccess;
 ...
 * 
 *      <xp:image url="/extlib/designer/markup/dataaccess/RestService.png">
 *      </xp:image>
 * 
 *  </xp:view>
 *
 */
public class RestServiceVisualizer extends AbstractCommonControlVisualizer{

private static final String REST_SERVICE_IMAGE = "RestService.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(REST_SERVICE_IMAGE, DATA_ACCESS_IMAGES_LOCATION));
