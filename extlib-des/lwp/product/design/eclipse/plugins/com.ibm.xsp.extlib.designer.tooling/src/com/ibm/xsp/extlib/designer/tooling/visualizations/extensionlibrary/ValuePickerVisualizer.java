 ...
 * 
 *      <xp:image url="/extlib/designer/markup/extensionlibrary/ValuePicker.png">
 *      </xp:image>
 * 
 *  </xp:view>
 *
 */
public class ValuePickerVisualizer extends AbstractCommonControlVisualizer{

    private static final String VALUE_PICKER_IMAGE = "ValuePicker.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(VALUE_PICKER_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION));
