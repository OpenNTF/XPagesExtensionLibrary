 ...
 *
 */
public class DojoToggleButton extends XPagesPaletteDropActionDelegate {

    /**
     * 
     */
    public DojoToggleButton() {
    }
    /* (non-Javadoc)
    ...
    protected void fillDefaultProperties(Element element) {
        ...
        XPagesDOMUtil.setAttribute(element, IExtLibAttrNames.EXT_LIB_ATTR_LABEL, "Dojo Toggle Button"); // $NLX-DojoToggleButton.DojoToggleButton-1$
    }
}