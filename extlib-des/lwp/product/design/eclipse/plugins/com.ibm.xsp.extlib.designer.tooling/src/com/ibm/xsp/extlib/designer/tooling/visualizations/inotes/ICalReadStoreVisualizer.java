 ...
 * 
 *      <xp:label style="border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px;margin-left:2px;margin-top:2px;margin-bottom:2px" value="iCal Store">
 *      </xp:label>
 * 
 *  </xp:view>
 *
 */
public class ICalReadStoreVisualizer extends AbstractCommonControlVisualizer{

    private static final String ICAL_STORE_STRING = "iCal Store"; // $NLX-ICalReadStoreVisualizer.iCalStore-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE,ICAL_STORE_STRING);
