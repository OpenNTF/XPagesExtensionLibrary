 ...
 *                  <xp:label style="margin-right:2px" value="Stack Container"></xp:label>
 ...
 *
 */
public class DjStackContainerVisualizer extends AbstractCommonControlVisualizer{

    private static String STACK_CONTAINER_STRING = "Stack Container"; // $NLX-DjStackContainerVisualizer.StackContainer-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, STACK_CONTAINER_STRING);
