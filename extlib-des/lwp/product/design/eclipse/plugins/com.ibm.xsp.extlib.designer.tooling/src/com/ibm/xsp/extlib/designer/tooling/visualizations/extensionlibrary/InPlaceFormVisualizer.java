 ...
 *          <xp:image url="/extlib/designer/markup/extensionlibrary/InPlaceFormIcon.png">
 *          </xp:image>
 *          <xp:callback>
 *          </xp:callback>
 *      </xp:panel> 
 ...
 *
 */
public class InPlaceFormVisualizer extends AbstractCommonControlVisualizer{

    private static final String IN_PLACE_FORM_IMAGE = "InPlaceFormIcon.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag listIcon = createImageTagObj(IN_PLACE_FORM_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION);
