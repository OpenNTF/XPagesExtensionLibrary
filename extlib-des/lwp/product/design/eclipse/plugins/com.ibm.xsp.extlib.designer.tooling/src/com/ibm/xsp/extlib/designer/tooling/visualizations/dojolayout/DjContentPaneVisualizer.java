 ...
 *                  <xp:label style="margin-right:2px" value="Dojo Content Pane"></xp:label>
 ...
 *
 */
public class DjContentPaneVisualizer extends AbstractCommonControlVisualizer{

    private static String DOJO_CONTENT_PANE_STRING = "Dojo Content Pane"; // $NLX-DjContentPaneVisualizer.DojoContentPane-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, DOJO_CONTENT_PANE_STRING);
