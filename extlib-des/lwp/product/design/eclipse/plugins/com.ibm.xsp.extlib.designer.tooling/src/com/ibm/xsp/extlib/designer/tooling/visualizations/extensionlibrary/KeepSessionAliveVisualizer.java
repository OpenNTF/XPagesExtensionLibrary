 ...
 * 
 *  <xp:image style="border-color:rgb(170,170,170);border-style:solid;border-width:thin" url="/extlib/designer/markup/extensionlibrary/ClockIcon.png">
 *  </xp:image>
 * 
 *  </xp:view>
 *
 */
public class KeepSessionAliveVisualizer extends AbstractCommonControlVisualizer{

    private static final String KEEP_SESSION_ALIVE_IMAGE = "ClockIcon.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag imageTag = createImageTagObj(KEEP_SESSION_ALIVE_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION);
        imageTag.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "border-color:rgb(170,170,170);border-style:solid;border-width:thin"); // $NON-NLS-1$
        strBuilder.append(imageTag);
