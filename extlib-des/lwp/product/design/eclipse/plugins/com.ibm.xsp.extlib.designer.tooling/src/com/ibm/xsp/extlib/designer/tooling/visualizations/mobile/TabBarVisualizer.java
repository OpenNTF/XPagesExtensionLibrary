 ...
 *                  <xp:label style="margin-right:5px" value="Tab Bar"></xp:label>
 ...
 *
 */
public class TabBarVisualizer extends AbstractCommonControlVisualizer{

    private static String TAB_BAR_STRING = "Tab Bar"; // $NLX-TabBarVisualizer.TabBar-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, TAB_BAR_STRING);
