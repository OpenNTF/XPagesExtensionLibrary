 ...
 * 
 *      <xp:image url="/extlib/designer/markup/extensionlibrary/PagerSaveState.png">
 *      </xp:image>
 * 
 *  </xp:view>
 *
 */
public class PagerSaveStateVisualizer extends AbstractCommonControlVisualizer{

    private static final String PAGER_SAVE_STATE_IMAGE = "PagerSaveState.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(PAGER_SAVE_STATE_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION));
