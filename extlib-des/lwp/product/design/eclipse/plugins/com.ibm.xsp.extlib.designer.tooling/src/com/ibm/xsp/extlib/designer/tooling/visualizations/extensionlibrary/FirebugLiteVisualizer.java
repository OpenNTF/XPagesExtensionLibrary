 ...
 * 
 *      <xp:label value="Firebug Lite" style="border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px">
 *      </xp:label>
 * 
 *  </xp:view>
 *
 */
public class FirebugLiteVisualizer extends AbstractCommonControlVisualizer{

    private static final String FIREBUG_STRING = "Firebug Lite"; // $NLX-FirebugLiteVisualizer.Firebug-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE,FIREBUG_STRING);
