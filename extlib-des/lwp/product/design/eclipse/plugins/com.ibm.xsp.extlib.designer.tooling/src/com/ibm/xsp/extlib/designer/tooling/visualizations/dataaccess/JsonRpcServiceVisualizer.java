 ...
 * 
 *      <xp:image url="/extlib/designer/markup/dataaccess/RPC.png">
 *      </xp:image>
 * 
 *  </xp:view>
 *
 */
public class JsonRpcServiceVisualizer extends AbstractCommonControlVisualizer{

    private static final String REMOTE_SERVICES_IMAGE = "RPC.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(REMOTE_SERVICES_IMAGE, DATA_ACCESS_IMAGES_LOCATION));
