 ...
 *                  <xp:label style="margin-right:2px" value="Dojo Data Grid Row"></xp:label>
 ...
 *
 */
public class DjxDataGridRowVisualizer extends AbstractCommonControlVisualizer{

    private static String DOJO_DATA_GRID_ROW_STRING = "Dojo Data Grid Row"; // $NLX-DjxDataGridRowVisualizer.DojoDataGridRow-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, DOJO_DATA_GRID_ROW_STRING);
