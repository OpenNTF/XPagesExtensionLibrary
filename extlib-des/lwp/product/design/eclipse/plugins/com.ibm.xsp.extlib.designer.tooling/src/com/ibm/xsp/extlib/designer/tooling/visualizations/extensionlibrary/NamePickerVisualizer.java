 ...
 * 
 *      <xp:image style="border-color:rgb(170,170,170);border-style:solid;border-width:thin" url="/extlib/designer/markup/extensionlibrary/NamePicker.png">
 *      </xp:image>
 * 
 *  </xp:view>
 *
 */
public class NamePickerVisualizer extends AbstractCommonControlVisualizer{

    private static final String NAME_PICKER_IMAGE = "NamePicker.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag imageTag = createImageTagObj(NAME_PICKER_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION);
