 ...
 * 
 *      <xp:label value="Dump Object" style="border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px">
 *      </xp:label>
 * 
 *  </xp:view>
 *
 */
public class DumpObjectVisualizer extends AbstractCommonControlVisualizer{

    private static final String DUMP_OBJECT_STRING = "Dump Object"; // $NLX-DumpObjectVisualizer.DumpObject-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px"); // $NON-NLS-1$
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE,DUMP_OBJECT_STRING);
