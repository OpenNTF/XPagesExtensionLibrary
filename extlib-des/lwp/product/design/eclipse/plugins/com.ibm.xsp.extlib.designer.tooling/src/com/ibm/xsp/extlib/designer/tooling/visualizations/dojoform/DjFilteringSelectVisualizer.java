 ...
 *
 */
public class DjFilteringSelectVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag comboTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_COMBO_BOX);
        comboTag.addAttribute(XSPAttributeNames.XSP_ATTR_ID, "comboBox1"); // $NON-NLS-1$
        strBuilder.append(comboTag.toString());
