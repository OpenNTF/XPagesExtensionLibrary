 ...
 *
 */
public class DjCheckBoxVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag checkboxTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_CHECKBOX);
        checkboxTag.addJSVarAttributeBinding(XSPAttributeNames.XSP_ATTR_TEXT, labelAttributeJSVar);
        checkboxTag.addAttribute(XSPAttributeNames.XSP_ATTR_ID, "checkBox1"); // $NON-NLS-1$
        strBuilder.append(checkboxTag.toString());
