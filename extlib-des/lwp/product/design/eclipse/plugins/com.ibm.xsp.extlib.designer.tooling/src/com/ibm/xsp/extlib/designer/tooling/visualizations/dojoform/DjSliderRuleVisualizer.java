 ...
 * 
 *  <xp:image url="/extlib/designer/markup/dojoform/sliderRule.png">
 *  </xp:image>
 * 
 *  </xp:view>
 *
 */
public class DjSliderRuleVisualizer extends AbstractCommonControlVisualizer{

    private static final String SLIDER_RULE_IMAGE = "sliderRule.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(SLIDER_RULE_IMAGE, DOJO_FORM_IMAGES_LOCATION));
