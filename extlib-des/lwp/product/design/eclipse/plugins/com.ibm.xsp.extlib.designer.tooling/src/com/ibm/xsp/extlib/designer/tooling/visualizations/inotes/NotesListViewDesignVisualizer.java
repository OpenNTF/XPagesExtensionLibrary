 ...
 * 
 *      <xp:label style="border-color:rgb(192,192,192);border-style:solid;border-width:2px;padding:2px;margin-left:2px;margin-top:2px;margin-bottom:2px" value="Notes List View Design">
 *      </xp:label>
 * 
 *  </xp:view>
 *
 */
public class NotesListViewDesignVisualizer extends AbstractCommonControlVisualizer{

    private static final String NOTES_LIST_VIEW_DESIGN_STRING = "Notes List View Design"; // $NLX-NotesListViewDesignVisualizer.NotesListViewDesign-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE,NOTES_LIST_VIEW_DESIGN_STRING);
