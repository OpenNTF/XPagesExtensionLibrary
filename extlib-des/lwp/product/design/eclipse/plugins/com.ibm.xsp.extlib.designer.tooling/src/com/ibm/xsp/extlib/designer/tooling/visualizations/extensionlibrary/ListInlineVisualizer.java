 ...
 *          <xp:image url="/extlib/designer/markup/extensionlibrary/ListInlineIcon.png">
 *          </xp:image>
 *          <xp:callback>
 *          </xp:callback>
 *      </xp:panel>
 ...
 *
 */
public class ListInlineVisualizer extends AbstractCommonControlVisualizer{

    private static final String INLINE_LIST_CONTAINER_IMAGE = "ListInlineIcon.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag listIcon = createImageTagObj(INLINE_LIST_CONTAINER_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION);
