 ...
 *          <xp:image url="/extlib/designer/markup/extensionlibrary/ListIcon.png">
 *          </xp:image>
 *          <xp:callback>
 *          </xp:callback>
 *      </xp:panel>
 ...
 *
 */
public class ListVisualizer extends AbstractCommonControlVisualizer{

    private static final String LIST_CONTAINER_IMAGE = "ListIcon.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag listIcon = createImageTagObj(LIST_CONTAINER_IMAGE, EXTENSION_LIBRARY_IMAGES_LOCATION);
