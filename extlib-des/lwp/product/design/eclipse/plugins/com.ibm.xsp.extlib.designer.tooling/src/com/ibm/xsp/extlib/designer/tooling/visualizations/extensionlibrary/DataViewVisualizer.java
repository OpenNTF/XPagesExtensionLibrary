 ...
 *  <xp:view xmlns:xp="http://www.ibm.com/xsp/core" style="font-size:16px">
 * 
 ...
 *      <tr>
 *          <td colspan="4" valign="top">
 *              <xp:label value="Category" id="label1"
 *                  style="font-weight:bold;font-size:12pt;font-family:sans-serif">
 *              </xp:label>
 *              <xp:br />
 *              <xp:callback facetName="categoryRow" />
 *          </td>
 *      </tr>
 *      <tr>
 *          <td valign="top" width="150" rowspan='2'>
 *              <xp:callback facetName="icon" />
 *          </td>
 ...
 *              <xp:label value="Extra Columns..." id="label2"
 ...
 *
 */
public class DataViewVisualizer extends AbstractCommonControlVisualizer{

    private static String CATEGORY_TEXT = "Category"; // $NLX-DataViewVisualizer.Category-1$
    private static String SUMMARY_TITLE_TEXT = "Summary title"; // $NLX-DataViewVisualizer.Summarytitle-1$
    private static String EXTRA_COLUMNS_TEXT = "Extra Columns..."; // $NLX-DataViewVisualizer.ExtralColumns-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append("<td colspan=\"4\" valign=\"top\">"); // $NON-NLS-1$
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "font-weight:bold;font-size:12pt;font-family:sans-serif"); // $NON-NLS-1$
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, CATEGORY_TEXT);
        strBuilder.append(label.toString());
        
        strBuilder.append("<xp:br />"); // $NON-NLS-1$
        strBuilder.append("<xp:callback facetName=\"categoryRow\" />"); // $NON-NLS-1$
        strBuilder.append("</td>"); // $NON-NLS-1$
        strBuilder.append("</tr>"); // $NON-NLS-1$
        strBuilder.append("<tr>"); // $NON-NLS-1$
        strBuilder.append("<td valign=\"top\" width=\"150\" rowspan='2'>"); // $NON-NLS-1$
        strBuilder.append("<xp:callback facetName=\"icon\" />"); // $NON-NLS-1$
        strBuilder.append("</td>"); // $NON-NLS-1$
        ...
        strBuilder.append("</td>"); // $NON-NLS-1$
        strBuilder.append("<td valign=\"top\" rowspan='2'>"); // $NON-NLS-1$
        
        Tag label3 = new Tag(XP_PREFIX,XSPTagNames.XSP_TAG_LABEL);
        label3.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "font-style:italic"); // $NON-NLS-1$
        label3.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, EXTRA_COLUMNS_TEXT);
        strBuilder.append(label3.toString());
