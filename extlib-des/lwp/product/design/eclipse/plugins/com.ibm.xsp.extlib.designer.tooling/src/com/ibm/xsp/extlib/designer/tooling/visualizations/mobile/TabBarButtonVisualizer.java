 ...
 *          labelValue="Tab Bar Button";
 *      }
 *      %>
 *
 *      <xp:button style="margin:1px"">
 ...
 *
 */
public class TabBarButtonVisualizer extends AbstractCommonControlVisualizer{

    private final static String TAB_BAR_BUTTON_LABEL = "Tab Bar Button"; // $NLX-TabBarButtonVisualizer.TabBarButton-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(generateFunctionToGetAttributeValue(XSPAttributeNames.XSP_ATTR_LABEL, getLabelDefaultValue(), labelAttributeJSVar));
        strBuilder.append(LINE_DELIMITER);
        
        Tag buttonTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_BUTTON);
        buttonTag.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "margin:1px"); // $NON-NLS-1$
        buttonTag.addJSVarAttributeBinding(XSPAttributeNames.XSP_ATTR_VALUE, labelAttributeJSVar);
        strBuilder.append(buttonTag.toString());
