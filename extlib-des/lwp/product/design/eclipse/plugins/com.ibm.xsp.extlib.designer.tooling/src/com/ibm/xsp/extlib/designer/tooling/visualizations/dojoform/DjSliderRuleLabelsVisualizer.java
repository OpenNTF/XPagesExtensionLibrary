 ...
 * 
 *  <xp:image url="/extlib/designer/markup/dojoform/sliderLabels.png">
 *  </xp:image>*
 * 
 *  </xp:view>
 *
 */
public class DjSliderRuleLabelsVisualizer extends AbstractCommonControlVisualizer{

    private static final String SLIDER_RULE_LABELS_IMAGE = "sliderLabels.png"; // $NON-NLS-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        strBuilder.append(createImageTag(SLIDER_RULE_LABELS_IMAGE, DOJO_FORM_IMAGES_LOCATION));
