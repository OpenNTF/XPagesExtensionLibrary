 ...
 *                  <xp:label style="margin-right:2px" value="iNotes List View"></xp:label>
 ...
 *
 */
public class ListViewVisualizer extends AbstractCommonControlVisualizer{

    private static String LIST_VIEW_STRING = "iNotes List View"; // $NLX-ListViewVisualizer.iNotesListView-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, LIST_VIEW_STRING);
