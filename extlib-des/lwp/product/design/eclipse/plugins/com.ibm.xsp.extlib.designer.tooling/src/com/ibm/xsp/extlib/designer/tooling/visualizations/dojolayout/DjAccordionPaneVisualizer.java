 ...
 *
 */
public class DjAccordionPaneVisualizer extends AbstractCommonControlVisualizer{

    private static String PANE_TITLE_STRING = "Accordion Pane"; // $NLX-DjAccordionPaneVisualizer.AccordionPane-1$
