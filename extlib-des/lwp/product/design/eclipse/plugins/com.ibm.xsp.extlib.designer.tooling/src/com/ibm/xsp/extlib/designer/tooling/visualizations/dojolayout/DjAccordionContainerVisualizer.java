 ...
 *                  <xp:label style="margin-right:2px" value="Accordion Container"></xp:label>
 ...
 *
 */
public class DjAccordionContainerVisualizer extends AbstractCommonControlVisualizer{

     private static String ACCORDION_CONTAINER_STRING = "Accordion Container"; // $NLX-DjAccordionContainerVisualizer.AccordionContainer-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        label.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, ACCORDION_CONTAINER_STRING);
