 ...
 * 
 *  <xp:inputTextarea style="height:20px">
 *  </xp:inputTextarea>
 * 
 *  </xp:view>
 *
 */
public class DjSpinnerTextBoxVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag buttonTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_INPUT_TEXTAREA);
        buttonTag.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "height:20px"); // $NON-NLS-1$
