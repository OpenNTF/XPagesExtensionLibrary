 ...
 * 
 *  <xp:button value=" Label" style="width:px;background-color:rgb(247,247,255);border-color:rgb(198,219,247);border-style:solid;border-width:1px;color:rgb(16,93,181)" icon="xsp://com.ibm.xsp.extlib.library~~/extlib/designer/markup/dojoform/DojoListTextBoxX.png" id="button1" dir="rtl">
 *  </xp:button>
 *  
 *  <xp:button value=" Label" style="width:px;background-color:rgb(247,247,255);border-color:rgb(198,219,247);border-style:solid;border-width:1px;color:rgb(16,93,181)" icon="xsp://com.ibm.xsp.extlib.library~~/extlib/designer/markup/dojoform/DojoListTextBoxX.png" id="button2" dir="rtl">
 *  </xp:button>
 *  
 *  <xp:button value=" Label" style="width:px;background-color:rgb(247,247,255);border-color:rgb(198,219,247);border-style:solid;border-width:1px;color:rgb(16,93,181)" icon="xsp://com.ibm.xsp.extlib.library~~/extlib/designer/markup/dojoform/DojoListTextBoxX.png" id="button3" dir="rtl">
 *  </xp:button>
 * 
 *  </xp:view>
 *
 */
public class DjListTextBoxVisualizer extends AbstractCommonControlVisualizer{

    private static final String LIST_TEXT_BOX_X_IMAGE = "DojoListTextBoxX.png"; // $NON-NLS-1$
    private static final String BUTTON_1_TEXT = "Label"; // $NLX-DjListTextBoxVisualizer.Label-1$
    private static final String BUTTON_2_TEXT = "Label"; // $NLX-DjListTextBoxVisualizer.Label.1-1$
    private static final String BUTTON_3_TEXT = "Label"; // $NLX-DjListTextBoxVisualizer.Label.2-1$
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag button3Tag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_BUTTON);
        button3Tag.addAttribute(XSPAttributeNames.XSP_ATTR_ID, "button3"); // $NON-NLS-1$
        button3Tag.addAttribute(XSPAttributeNames.XSP_ATTR_STYLE, "width:px;background-color:rgb(247,247,255);border-color:rgb(198,219,247);border-style:solid;border-width:1px;color:rgb(16,93,181)"); // $NON-NLS-1$
        button3Tag.addAttribute(XSPAttributeNames.XSP_ATTR_BUTTON_ICON, imageURL);
        button3Tag.addAttribute(XSPAttributeNames.XSP_ATTR_BIDI, XSP_ATTR_VAL_RTL);
        button3Tag.addAttribute(XSPAttributeNames.XSP_ATTR_VALUE, padString(BUTTON_3_TEXT));
        strBuilder.append(button3Tag.toString());
