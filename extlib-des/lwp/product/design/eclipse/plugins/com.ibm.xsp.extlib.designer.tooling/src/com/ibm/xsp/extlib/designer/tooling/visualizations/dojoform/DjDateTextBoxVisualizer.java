 ...
 *
 */
public class DjDateTextBoxVisualizer extends AbstractCommonControlVisualizer{
    ...
    public String getXSPMarkupForControl(Node nodeToVisualize,  IVisualizationCallback callback, FacesRegistry registry) {
        ...
        Tag convertDateTimeTag = createTag(XP_PREFIX, XSPTagNames.XSP_TAG_CONVERTER_CONVERT_DATE_TIME);
        convertDateTimeTag.addAttribute(XSPAttributeNames.XSP_ATTR_TYPE, XSPAttributeNames.XSP_ATTR_VAL_DATE);
        thisConverterTag.addChildTag(convertDateTimeTag);
